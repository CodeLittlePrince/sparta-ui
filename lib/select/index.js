...
var render = function() {
  ...
  return _c("transition", { attrs: { name: "ev-zoom-in-center" } }, [
    _c(
      "span",
      { staticClass: "ev-tag", class: "ev-tag--" + _vm.type },
      [
        _vm._t("default"),
        _vm._v(" "),
        _vm.closable
          ? _c(
              "i",
              { staticClass: "ev-icon-close", on: { click: _vm.handleClose } },
              [_vm._v("X")]
            )
          : _vm._e()
      ],
    ...
    [
      _c(
        "div",
        {
          ...
          staticClass: "ev-select-input-box",
        ...
        [
          ...
          _c(
            "p",
            {
              ...
              staticClass: "ev-select-input-placeholder",
              on: { click: _vm.focusSelectInput }
            },
            ...
            [
              ...
              _c(
                "i",
                {
                  ...
                  staticClass: "ev-icon-arrow-down"
                },
                [_vm._v("v")]
              )
            ]
      ...
      _c(
        "ev-select-dropdown",
        { ref: "ev-select-dropdown" },
        [
          _c("transition", { attrs: { name: "ev-zoom-in-top" } }, [
            _c(
              "ul",
              {
                directives: [
              ...
              [
                ...
                _c(
                  "li",
                  {
                    ...
                    staticClass:
                      "ev-option is-disabled ev-select-list-emptyText",
                    on: {
                      click: function($event) {
                        $event.stopPropagation()
                      }
...
var select_dropdownvue_type_template_id_4ef401d7_render = function() {
  ...
  return _c(
    "div",
    { staticClass: "ev-select-dropdown" },
    [_vm._t("default")],
    2
  )
}
...
/* harmony default export */ var srcvue_type_script_lang_js_ = ({
  name: 'EvSelect',
  components: {
    'ev-select-dropdown': select_dropdown,
    'ev-tag': src["a" /* default */]
  },
  ...
  methods: {
    ...
    setTagboxWidth: function setTagboxWidth() {
      this.tagBoxWidth = "".concat(parseFloat(window.getComputedStyle(this.$refs['ev-tag-box'].parentNode).width) - 38, "px");
    },
    updateTagboxHeight: function updateTagboxHeight() {
      ...
      if (this.selected.length) {
        this.$nextTick(function () {
          // 更新容器的高度
          var style = window.getComputedStyle(_this2.$refs['ev-tag-box']);
          ...
          _this2.$refs['ev-select-suffix'].style.height = height + 'px';
          _this2.$refs['ev-select-suffix'].style.lineHeight = height + 'px'; // 更新dropdown的位置

          _this2.$refs['ev-select-dropdown'].updateTop(height + 2);
        });
      }
    },

  ...
  >
    ...
    >
      <sp-select v-model="validateForm1.monsterFeed">
        ...
        <sp-option label="草系" value="grass"/></sp-option>
        <sp-option label="岩系" value="rock"/></sp-option>
        <sp-option label="雷系" value="thunder"/></sp-option>
        <sp-option label="风系" value="wind"/></sp-option>
        <sp-option label="岩系" value="rock"/></sp-option>
        <sp-option label="草系" value="grass"/></sp-option>
      </sp-select>
    </sp-form-item>

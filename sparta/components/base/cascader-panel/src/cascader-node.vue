...
import SpRadio from 'base/radio'
import { isEqual } from 'sparta/common/js/utils/tool'
...
export default {
  ...
  methods: {
    ...
    renderLoadingIcon() {
      return (
        <i class="sp-icon-loading sp-cascader-node__postfix"></i>
      )
    },

    renderExpandIcon() {
      return (
        <i class="sp-icon-arrow-right sp-cascader-node__postfix"></i>
      )
    },

...
import scrollbarWidth from 'sparta/common/js/utils/scrollbar-width'
import { toObject } from 'sparta/common/js/utils/tool'
import Bar from './bar'
...
export default {
  ...
  render(h) {
    ...
    return h('div', { class: 'sp-scrollbar' }, nodes)
  },
